            ...
            if (!await context.Promotions.AnyAsync())
            {
                var promotions = new List<Promotion>
                {
                    ...
                    new Promotion
                    {
                          Id = Guid.NewGuid(),
                          Percent = 10,
                          Description = "10 percent off of the entire order"
                    ...
                    new Promotion
                    {
                          Id = Guid.NewGuid(),
                          Percent = 15,
                          Description = "15 percent off of the entire order"
                    ...
                    new Promotion
                    {
                           Id = Guid.NewGuid(),
                           Percent = 40,
                           Description = "40 percent off of the entire order"
                    ...
                    new Promotion
                    {
                           Id = Guid.NewGuid(),
                           Percent = 50,
                           Description = "50 percent off of the entire order"
                    ...
                    new Promotion
                    {
                           Id = Guid.NewGuid(),
                           Percent = 25,
                           Description = "25 percent off of the entire order"
